...
note:
1. I all features are encoded except ord_5. Please help to find a neat way to encode ut;
2. Things like feature scaling, normaliztion, standardization, regularization, dropout have not been implmentated. Please help to do so;
